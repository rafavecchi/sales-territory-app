# 90-Day Action Plan — Utah Launch, Club-Store Track
...
## Weeks 7–9 — Prove demand in Utah
- [ ] Book **2–3 farmers markets / festivals** (SLC Downtown Farmers Market, cultural/food festivals). Sell, sample, and **log velocity + conversion**.
- [ ] Pitch **Harmons** (local-brand friendly) + 2–3 independents for a 10–20 ct trial SKU.
- [ ] Shoot a **content library** of air-fryer crisp-up + dip videos; start posting.
- [ ] Apply for **Costco Road Shows** and **Sam's Club demo events** with your early data.

## Weeks 10–12 — Convert proof into a slot
- [ ] Assemble the **buyer packet**: units/day, sampling conversion, repeat interest, margin math, capacity proof.
- [ ] Confirm **cold-chain distribution** path (frozen distributor or ship-to-depot).
- [ ] Stress-test **supply**: can the co-packer fill a warehouse-level order at your lead time — and can you finance the run?
- [ ] **Secure a Road Show date** (or a regional-buyer meeting) and prep to staff/run it.

## Standing weekly rhythm
- [ ] Update velocity dashboard (units/day, conversion, reorders).
- [ ] Guard the margin — re-check COGS as volume changes.
- [ ] Log every retailer/demo lead (use the Nox canvassing app as you widen to independents/grocery).
